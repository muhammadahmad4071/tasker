        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @role('Admin')
                    Admin
                @else
                    <strong>Current Points:</strong> {{ $points->value }}
                @endrole
                </div>
            </div>
            @role('User')
            <h1 class="mt-8 mb-3 font-bold text-xl">Todays Completed Tasks</h1>
            ...
            <h1 class="mt-8 mb-3 font-bold text-xl">Todays Pending Tasks</h1>
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  <th
            ...
            <h1 class="mt-8 mb-3 font-bold text-xl">Total Completed Tasks</h1>
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  <th
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                @foreach ($totalCompletedTasks as $task)
                  <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm font-medium text-gray-900">{{$task->name}}</div>
                    </td>
